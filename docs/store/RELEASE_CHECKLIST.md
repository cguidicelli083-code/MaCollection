...
- [x] App renommée "Ma Collection Retro Gaming" partout (app, fiche Store, politique de
      confidentialité, description du dépôt GitHub).
- [x] GitHub Pages vérifié actif (`https://cguidicelli083-code.github.io/MaCollection/`, branche
      main, dossier /docs) — la politique de confidentialité est en ligne et à jour.
...
3. **Dans Play Console** (nouvelle app) :
   ...
   - Coller l'URL de la politique de confidentialité : `https://cguidicelli083-code.github.io/MaCollection/privacy-policy.html`.
...
4. **Après publication** : pense à sauvegarder le keystore (`macollectionv2-release.jks`) et son mot de passe (dans `local.properties`) ailleurs que sur ce PC (gestionnaire de mots de passe, cloud chiffré...) — leur perte rendrait impossible toute future mise à jour de l'app.
